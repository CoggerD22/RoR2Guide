...
| `acceleration` | Survivor | `baseAcceleration` from the body prefab — how fast the survivor reaches top speed, NOT what that speed is. The only base stat that varies across the roster while appearing nowhere on the site or in the game's own sheet: MUL-T 30, Artificer 40, False Son 50, the other sixteen 80. |
